    ...
    if (message.data.startsWith(":::::::::-::::::::::::::::-:::::::::::-:::::-::::")) {
        ...
        if (messagePassed[1] == "SessionFull") {
            ...
            if (JustJoin == true) {
                ...
                question += "<table><tr>";
                question += "<td  style='width:80%;position:relative;left:20px'><b style='color:" + QuestionColor + ";font-size:28px;font-style: italic;'>" + messagePassed[1] + "</b><br/><br/>";
                var lables = "";
                ...
                question += "<td style='width:20%'><b style='color:" + QuestionColor + ";position:relative;left:100px;'>Clue</b><br/><img style='position:relative;top:10px;left:50px;width:60%;height:110px;border-radius: 5px;' src='http://localhost/Images/" + messagePassed[4] + "'/></td></tr></table>";
                question += "</div>";
        ...
        if (message.data.includes(":::::::::-::::::::::::::::-:::::::::::-:::::-::::")) {
            ...
            var question = "<div  style='width:100%;height:150px;background-color:silver;border-radius: 10px;opacity: 0.83;'>";
            question += "<table><tr>";
            question += "<td  style='width:80%;position:relative;left:20px'><b style='color:" + QuestionColor + ";font-size:28px;font-style: italic;'>" + questionTokens[0] + "</b><br/><br/>";
            var lables = "";
            ...
            question += "<td style='width:20%'><b style='color:" + QuestionColor + ";position:relative;left:100px;'>Clue</b><br/><img style='position:relative;top:10px;height:110px;left:50px;width:60%;border-radius: 5px;' src='http://localhost/Images/" + questionTokens[3] + "'/></td></tr></table>";
            question += "</div><br/>";
            document.getElementById("content").innerHTML += question;
            document.getElementById("content1").scrollTop = document.getElementById("content1").scrollHeight;
        }
